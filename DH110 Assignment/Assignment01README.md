...
**Match Between System and Real World** | **Issue:**  Throughout the site, drop down menus and hyperlinks are accompanied by side arrows. Although dropdown menus utilize down areas to signify additional dropdown choices, side arrows represent to the user that they should click the link. Since down arrows represent that a dropdown menu is available, it may not be intuitve to the user that side arrows mean to click. ![website of MA Department of Early Education and Care](DHReal.png) | **Improvement:** Consider changing the side arrows to just bold or underlined text when the user is hovering over the link. | 1  
**User control and freedom** | **Good:** In notifications, there is a list of notifications that have been sent by instructor to the class through CCLE. I have multiple messages but there is no back button. Three dots at the top do not have a back button. | **Improvement:** Place a back button option at the top in addition to the three dot icon.
